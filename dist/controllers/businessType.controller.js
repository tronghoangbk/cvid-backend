...
const getAll = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const typeCompanies = yield (0, model_service_1.findManyService)(businesstype_model_1.default, {});
...
const createMany = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield Promise.all(data.map((item) => __awaiter(void 0, void 0, void 0, function* () {
            yield (0, model_service_1.createService)(businesstype_model_1.default, item);
        })));
