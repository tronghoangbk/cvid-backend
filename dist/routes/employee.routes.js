...
employeeRouter.post("/add-work/:id", other_middleware_1.checkLogin, employee_controller_1.addWorkExperience);
employeeRouter.delete("/delete-work/:id/:workId", other_middleware_1.checkLogin, employee_controller_1.deleteWorkExperience);
